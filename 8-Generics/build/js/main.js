...
const stringEcho = (arg) => arg; // this is fine but it ONLY works with a string type
// what if we want to add a generic function and we make the arg more abstract so that it could be any type?
const echo = (arg) => arg; // T - type variable   --> now this function is Generic and it works with ANY type ! 
...
const myState = new StateObject([15]); // default parameter - [15]
